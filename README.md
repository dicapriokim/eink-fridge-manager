...
- **Key Features**:
  ...
  - **Intuitive UI/UX**:
    ...
    - **Data Integrity**: Stable Unicode handling via NFC normalization and **Leading Whitespace Preservation** (BOM + NBSP) for custom indentation on E-ink displays.
    - **Balanced UI**: Clean left-aligned text for better readability and a seamless user experience.
...
### 6. 주의 사항
- **공백 및 인덴트**: 사용자가 품목명 앞에 입력한 공백은 **BOM(U+FEFF) + NBSP(U+00A0) 기법**을 통해 E-ink 디스플레이까지 무결하게 보존됩니다. (단, 뒷부분 공백은 자동으로 제거됩니다.)
