# E-ink Fridge Manager (Fridge Inventory Management v5.1.0)
...
단기 / 장기에 떄라서 디스플레이에 표시될 내용이 달라집니다.
스크립트에서 조건문으로 단기 / 장기 각각의 디스플레이 디자인 2가지로 자동 선택되게 할 수 있습니다.
      ...
      - conditions:
        ...
        sequence:
          - action: gicisky.write
            target:
              device_id:
                - 2fea05a26af8bbb01907c40c27a7ac6d
            data:
              payload:
                payload:
                  - type: rectangle
              ...
              payload:
                payload:
                  - type: rectangle
                    ...
                    fill: red
    enabled: true
alias: 냉장고 E-ink 재고 스크립트
description: v3 앱에서 주입된 변수를 사용하여 E-ink 화면을 직접 렌더링합니다.
```

---
**Designed by 돼지지렁이 (PigWorm) v.5.1.0**
